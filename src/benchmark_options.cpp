...
BenchmarkOptions parseBenchmarkOptions(const QCommandLineParser& parser, bool benchmarkOverlayOption) {
  ...
  options.overlayEnabled = benchmarkOverlayOption && !parser.isSet("no-overlay");
