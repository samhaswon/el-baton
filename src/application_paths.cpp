...
QString ApplicationPaths::dataFileForApplication(
...
QString ApplicationPaths::dataFile(const QString& name, const QString& buildFallback) {
  return dataFileForApplication(QCoreApplication::applicationDirPath(), name, buildFallback);
}
