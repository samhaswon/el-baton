...
struct ApplicationPaths final {
  ...
  [[nodiscard]] static ApplicationPaths
  fromBaseDirectories(const QString &configBase, const QString &cacheBase,
                      const QString &runtimeBase);
  [[nodiscard]] static ApplicationPaths system();
  [[nodiscard]] static QString dataFile(const QString &name,
  ...
  dataFileForApplication(const QString &applicationDirectory,
                         const QString &name,
                         const QString &buildFallback = {});
