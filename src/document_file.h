...
public:
  [[nodiscard]] static std::optional<DocumentFile>
  load(const QString &path, QString *errorMessage = nullptr);
  [[nodiscard]] static std::optional<DocumentFile>
  create(const QString &path, const QString &title,
  ...
  [[nodiscard]] bool saveBody(const QString &body,
                              QString *errorMessage = nullptr,
                              bool updateModified = false);
  [[nodiscard]] bool setMetadataFlag(NoteFlag flag, bool enabled,
                                     QString *errorMessage = nullptr);
  [[nodiscard]] bool setTags(const QStringList &tags,
                             QString *errorMessage = nullptr);
  [[nodiscard]] bool setAttachments(const QStringList &attachments,
                                    QString *errorMessage = nullptr);
  [[nodiscard]] bool writeCopy(const QString &path, const QString &title,
                               const QString &body,
                               QString *errorMessage = nullptr,
