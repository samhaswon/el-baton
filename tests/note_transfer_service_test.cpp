...
void NoteTransferServiceTest::importsEnexNotesAndResources() {
  ...
  QVERIFY(QFileInfo::exists(
      directory.filePath(QStringLiteral("workspace/attachments/hello.txt"))));
  const auto imported = qt_editor::DocumentFile::load(
