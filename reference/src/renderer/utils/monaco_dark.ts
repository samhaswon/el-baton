...
const Dark: monaco.editor.IStandaloneThemeData = {
  ...
  rules: [
    ...
    { token: 'keyword.math',           foreground: '#6796E6' },
    { token: 'keyword.math.fence',     foreground: '#EF6C00' },
    ...
    { token: 'operator.math',          foreground: '#F44747' },
    { token: 'operator.sql',           foreground: '#778899' },
    { token: 'operator.swift',         foreground: '#666666' },
    { token: 'predefined.sql',         foreground: '#B267E6' },
    { token: 'regexp',                 foreground: '#E0D463' },
    { token: 'string',                 foreground: '#F6F6F6' },
    { token: 'string.math',            foreground: '#F6F6F6' },
    { token: 'string.math.inline',     foreground: '#EF6C00' },
    ...
    { token: 'number.math',            foreground: '#6796E6' },
    { token: 'delimiter.math',         foreground: '#F6F6F6' },
    { token: 'comment.math',           foreground: '#AFAFAF' },
